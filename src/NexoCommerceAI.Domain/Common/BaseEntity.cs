...
using MediatR;
using NexoCommerceAI.Domain.Abstractions;
...
public abstract class BaseEntity
{
    ...
    public void AddIntegrationEvent(IIntegrationEvent eventItem) => _integrationEvents.Add(eventItem);
    public void RemoveIntegrationEvent(IIntegrationEvent eventItem) => _integrationEvents.Remove(eventItem);
